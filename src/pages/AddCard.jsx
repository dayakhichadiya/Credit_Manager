...
const AddCard = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-6 w-full">
       {/* <button
        className="absolute top-4 right-6 bg-blue-600 text-white px-4 py-2 rounded-lg shadow hover:bg-blue-700 transition-all"
        onClick={() => navigate("/cardList")}
      >
        View Saved Cards
      </button> */}
      ...
      {/* Card Preview */}
      <div className="bg-gradient-to-r from-blue-500 to-blue-700 text-white p-6 rounded-xl w-96 shadow-lg mb-6">
        <p className="text-sm mb-2 font-semibold">Card Preview</p>
        <div className="flex justify-between uppercase text-lg mt-2 font-semibold">
          <span>{cardHolder || "CARDHOLDER NAME"}</span>
          <span>{expiry || "MM/YY"}</span>
        </div>
        <div className="mt-4 text-2xl font-bold tracking-widest text-center">
          {cardNumber || "**** **** **** ****"}
        </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow-lg w-96 space-y-4">
        ...
        <div>
          ...
          <input
            type="text"
            className="w-full p-2 border border-gray-300 rounded-lg mt-1 focus:ring-2 focus:ring-blue-500 outline-none"
            placeholder="First Last"
            value={cardHolder}
            onChange={(e) => setCardHolder(e.target.value)}
          />
        ...
        <div>
          ...
          <select
            className="w-full p-2 border border-gray-300 rounded-lg mt-1 bg-white focus:ring-2 focus:ring-blue-500 outline-none"
            value={bankName}
        ...
        <button type="submit" className="w-full bg-blue-600 text-white p-2 rounded-lg mt-4 hover:bg-blue-700 transition-all">
          Add Card
        </button>
      </form>
    </div>
